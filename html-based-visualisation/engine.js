$(function() {
    ...
    window.Graph = {
        ...
        createCircle: function (x, y, space, id) {
            let circle = document.createElementNS(this.svg, 'circle');
            ...
            circle.setAttributeNS('', 'onclick', 'Graph.createNode(event, \'left\', ' + space + ')');

            this.graph.appendChild(circle);
        },
        createLine: function (x1, y1, x2, y2) {
            let line = document.createElementNS(this.svg, 'line');
        ...
        createNode: function (event, direction, space) {
            ...
            if (direction === 'left') {
                target.setAttribute('onclick', 'Graph.createNode(event, \'right\', ' + space + ')');
        ...
        run: function(tasks, p1, p2, parent) {
            let k1 = 0, k2 = 0, baer = null, children = null;
            ...
            baer = setInterval(function () {
                ...
                node = document.getElementById(task.getAttribute('id'));
